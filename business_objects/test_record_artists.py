...
class RecordArtistsTest(unittest.TestCase):
    ...
    def test_add_member(self):
        ...
        self.assertEqual(test_members[0].member_id, group_member.member_id)
        self.assertEqual(test_members[0].artist_id, record_artist.artist_id)
        self.assertEqual(test_members[0].member_from_date.strftime('%Y-%m-%d'), '2021-01-01')
        self.assertEqual(test_members[0].member_to_date.strftime('%Y-%m-%d'), '2021-12-31')
